...
usbrelay 6QMBS_$MOTORS=0  > /dev/null
sleep 0.5
usbrelay 6QMBS_$SPK1=0 > /dev/null
usbrelay 6QMBS_$SPK2=0 > /dev/null
usbrelay 6QMBS_$SPK3=0 > /dev/null
usbrelay 6QMBS_$SPK4=0 > /dev/null
usbrelay 6QMBS_$SPK5=0 > /dev/null
usbrelay 6QMBS_$SPK6=0 > /dev/null
sleep 0.5
usbrelay 6QMBS_$DMX=0 > /dev/null
sleep 0.2
usbrelay
